...
class Mailmodel extends CI_Model
{
    public $smtp_config = array(
        'protocol' => 'smtp',
        'smtp_host' => 'ssl://mail.e.blindtex.co.uk',
        'smtp_port' => 465,
        'smtp_user' => 'admin@e.blindtex.co.uk',//test@gmail.com
        'smtp_pass' => 'Intoshade@Application@2023',//Password
        'mailtype'  => 'html',
        'charset'   => 'iso-8859-1',
        // 'charset' => 'utf-8',
        // 'wordwrap' => TRUE,
    );
    public $smtp_user_name = "admin@e.blindtex.co.uk";
    public $use_smtp = 1;
