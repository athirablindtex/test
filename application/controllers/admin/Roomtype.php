...
class Roomtype extends MY_Controller
	{
		...
		public function list($type="list",$id=""){
				...
				$this->form_validation->set_rules('name','Room Type Name','required|trim|alpha_numeric_spaces|min_length[3]|max_length[20]');
