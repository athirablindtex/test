...
class Pricebandversion extends MY_Controller
	{
		 var $module_id = 'id';
		 var $single_name="pricebandversion";
		...
		public function __construct(){
				...
				$this->module_caption='Price Band Version';
				$this->module_active='master';
				$this->module_active_sub=$this->single_name;
				$this->controller=$this->single_name;
				$this->permission='priceband';
				$this->check_user_privillages($this->permission.'_list');
				$this->load->model(array($this->module_model,'salespersonmodel'));
				
			}
		public function list($type="list",$id=""){
				$module_model=$this->module_model;
				$view_folder=$this->view_folder;
				$this->form_validation->set_rules('name','Price Band Version Name','required|trim|alpha_numeric_spaces|min_length[2]|max_length[20]');
