...
<?php if(validation_errors()){ ?>
  ...
  <strong>Error!</strong>  <?php echo validation_errors(); ?>
      ...
      <div class="col-lg-6">
        <div class="form-group">
			<label>E-mail</label>
          <input class="form-control" type="text" name="email" placeholder="E-mail" value="<?php echo @$res->email!=''?@$res->email:$this->input->post('email'); ?>" required>
       </div>
        </div>
        <div class="col-lg-6">
        <div class="form-group">
			<label>Employee Limit</label>
          <input class="form-control" type="text" name="employees_limit" placeholder="Employees Limit" value="<?php echo @$res->employees_limit!=''?@$res->employees_limit:$this->input->post('employees_limit'); ?>" required>
       </div>
        </div>
        <div class="col-lg-6">
        <div class="form-group">
                ...
                <div class="input-group date">
                  ...
                  <input type="text" class="form-control pull-right" id="datepicker" name="expiry_date" value="<?php echo @$res->expiry_date?date('m/d/Y',strtotime($res->expiry_date)):''; ?>">
                </div>
                <!-- /.input group -->
              </div>
        </div>
          ...
          <input class="form-control" type="password" name="password" placeholder="Password" <?= @$this->uri->segment(4) ? '' : 'required'; ?>>
           ...
           <div class="form-group">
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    ...
                                    <input type="file" id="file" onmouseover="$('#file').tooltip('show')" title="Choose one image file" name="image">
                                </div>
                            </div>

                            <div class=" col-lg-12 col-md-12 col-sm-12 col-xs-12  div-unstyle form-set">
                                <div class="form-group">   
                                    <div class="form-body">
                                        <div class="containers">
                                            <div class="imageBox"> 
                                                ...
                                                <div class="thumbBox">
                                                    ...
                                                    /*  if(@$this->uri->segment(4))
                                                      ...
                                                      <img src="<?php echo base_url(); ?>uploads/album/image/<?php echo @$res->files; ?>" >
                                                      <?php
                                            ...
                                            <div class="cropped">
                                                ...
                                                if ($this->uri->segment(4) > 0) {
                                                    if (@$res->image != '') {
                                                        ?>
                                                        <img src="<?php echo base_url() . 'uploads/users/' . @$res->image; ?>" width="500px">
                                                        <?php
                                                    }
                                                }
                                                ?>   
                            ...
                            <input type="hidden" name="cropped_image" id="cropped_image" value="1" > 
