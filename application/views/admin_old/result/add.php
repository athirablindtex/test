...
<?php if(validation_errors()){ ?>
  ...
  <strong>Error!</strong>  <?php echo validation_errors(); ?>
        ...
        <div class="form-group">
			<label>Title</label>
          <input class="form-control" type="text" name="name" placeholder="Title" value="<?php echo @$res->name!=''?@$res->name:$this->input->post('name'); ?>" required>
       </div>
        </div>
        ...
        <div class="form-group">
			<label>F/R</label>
          <input class="form-control" type="text" name="fr" placeholder="F/R" value="<?php echo @$res->fr!=''?@$res->fr:$this->input->post('fr'); ?>">
       </div>
        </div>
        ...
        <div class="form-group">
			<label>S/R</label>
          <input class="form-control" type="text" name="sr" placeholder="S/R" value="<?php echo @$res->sr!=''?@$res->sr:$this->input->post('sr'); ?>">
       </div>
        </div>
        ...
        <div class="form-group">
                ...
                <div class="input-group date">
                  ...
                  <input type="text" class="form-control pull-right" id="datepicker" name="result_date" value="<?php echo @$res->result_date?date('m/d/Y',strtotime($res->result_date)):''; ?>">
                </div>
                <!-- /.input group -->
              </div>
        </div>
