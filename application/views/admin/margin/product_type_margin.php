                            ...
                            <div class="col-sm-12 bg-white shadow-sm rounded-3 p-4 r">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <!-- Price Band Dropdown -->
                                        <div class="form-group col-md-6">
                                            <label for="price_band">Select Sub Product Type</label>
                                        ...
                                        <div class="row align-items-end">
                                            ...
                                            <div class="col-md-6 text-end">
                                                <button type="submit" id="savePriceBand" class="btn btn-lg text-white px-4 shadow-sm"
...
<script>
    ...
    $.ajax({
        ...
        $('#product_type').on('change', function() {
            ...
            if (productTypeId) {
                $.ajax({
                    url: '<?= base_url("admin/product/getProductByType") ?>',
                    type: 'POST',
                    data: {
        ...
        $('#margin').on('input', function() {
            ...
            console.log('tables are' + originalTableData);
            if (type === 'Matrix' && originalTableData.length) {
