                  ...
                  <tbody>
                    ...
                    <?php foreach ($tabledata as $product) { ?>
                      <tr>
                        ...
                        <td><?= ucwords(@$product['customer_name']); ?></td>
                        <td><?= ucwords(@$product['from_name']); ?></td>
                        <td><?= ucwords(@$product['to_name']); ?></td>
                <?php
$admin = $this->db->where('id', $product['transferred_by'])
                  ->get('admin_users')
                  ->row();
?>
                        ...
                        <td>
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                              <?php if (@$product['transfer_status'] == "Pending") { ?>
                                <a class="dropdown-item" href="<?= site_url() . 'admin/quotationtransfer/status_approve/' . @$product['id']; ?>">Approved</a>
                                <a class="dropdown-item" href="<?= site_url() . 'admin/quotationtransfer/status_reject/' . @$product['id']; ?>">Reject</a>
                              <?php } ?>
                            </div>
                          </div>
                        </td>
