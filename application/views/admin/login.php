...
<body class="login">
   <div class="wrapper wrapper-login">
      <div class="container container-login animated fadeIn">
            <a href="index.php" class="logo">
               <img src="<?php echo base_url(); ?>assets/admin/img/Blindtex-logo.png" alt="navbar brand" class="w-50 mx-auto d-block mb-5">
            </a>
         <h3 class="text-center">Sign In To Admin</h3>
         <form action="" method="post">
         <div class="login-form">
            <div class="form-group form-floating-label">
               <input id="email" name="email" value="<?php echo $this->input->post('email'); ?>" autocomplete="off" type="email" class="form-control input-border-bottom" required>
					<label for="email" class="placeholder">Email</label>
            </div>
            <div class="form-group form-floating-label">
            <input id="password" name="password" placeholder="" type="password" autocomplete="off" class="form-control input-border-bottom" required>
   ...
   <script src="<?php echo base_url(); ?>assets/admin/js/ready.js"></script>
   
   <script src="<?php echo base_url(); ?>assets/admin/js/plugin/bootstrap-notify/bootstrap-notify.min.js"></script>
    <!-- AdminTheme Alerts -->
    <script src="<?= site_url(); ?>assets/admin/js/theme/alerts.js"></script>
      <script>
      <?php if($this->session->flashdata('info')){  ?>
         tfna_alert_danger('Error','<?php echo $this->session->flashdata("info");?>')
      <?php } ?>
      </script>
</body>
</html>