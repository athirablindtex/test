   ...
   <head>
      ...
      <script>
         WebFont.load({
         	...
         	custom: {"families":["Flaticon", "Font Awesome 5 Solid", "Font Awesome 5 Regular", "Font Awesome 5 Brands"], urls: ['<?= base_url(); ?>assets//admin/css/fonts.css']},
         	active: function() {
      ...
      <link rel="stylesheet" href="<?= base_url(); ?>assets/admin/css/admintheme.css">
