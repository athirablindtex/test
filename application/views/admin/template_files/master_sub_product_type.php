               ...
               <div class="card">
                  <div class="card-header">
                     <div class="d-flex align-items-center">
                        <h4 class="card-title">Master - Sub Product Type</h4>
                      

                        <div class="btn-group btn-group-page-header ml-auto show">

                           <button class="btn btn-success btn-rounded ml-auto" data-toggle="modal" data-target="#subProductTypeModal">
                        <i class="fa fa-plus"></i>
                        Add New Sub Product Type
                        </button>
